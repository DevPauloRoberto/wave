        ...
        <div class="grid grid-cols-12 my-4 md:mb-6 items-end">
            ...
            <div class="col-span-10 col-start-2 md:col-span-2 flex justify-center md:justify-end py-2">
                <Button 
                    ...
                    @click="navigateTo('/admin/noticias/create')" 
                />
            </div>
        </div>
...
const confirmDelete = (categoria: NoticiaListaAdmin) => {
    confirm.require({
        message: `Tem certeza que deseja excluir a noticia "${categoria.titulo}"?`,
        ...
        accept: async () => {
            try {
                await $fetch(`/api/admin/noticias/${categoria.id}`, { method: 'DELETE' });
